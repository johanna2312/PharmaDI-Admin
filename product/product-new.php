        ...
        <div class="w-[87%]">
            ...
            <div class="flex flex-col px-[40px] py-[20px] text-[#505050]">
                ...
                <div class="flex items-center text-[14px]">
                    <span class="px-1 cursor-pointer" onclick="window.location.href='http://localhost/PharmaDI-Admin/product/product-list.php'">Danh sách sản phẩm</span>
                ...
                <div class="flex justify-between mt-1">
                    ...
                    <div class="relative" onclick="showDroplist('cate-droplist')">
                        ...
                        <div class="absolute flex flex-col bg-white z-10 w-full py-1 rounded-[6px] border border-[#d8d8d8] text-[13px] hidden"
                            id="cate-droplist">
                            <span class="hover:bg-gray-100 px-[20px] py-[2px] text-[#505050]">1</span>
                            <span class="hover:bg-gray-100 px-[20px] py-[2px] text-[#505050]">2</span>
                            <span class="hover:bg-gray-100 px-[20px] py-[2px] text-[#505050]">3</span>
                            <span class="hover:bg-gray-100 px-[20px] py-[2px] text-[#505050]">4</span>
                            <span class="hover:bg-gray-100 px-[20px] py-[2px] text-[#505050]">5</span>
                        </div>
                    </div>
                    <div class="relative" onclick="showDroplist('tag-droplist')">
                ...
                <div class="flex justify-between mt-5">
                    <div class="relative" onclick="showDroplist('brand-droplist')">
                        <span
                    ...
                    <div class="relative" onclick="showDroplist('country-droplist')">
                ...
                <div class="relative flex justify-between mt-5 w-full">
                    ...
                    <textarea name="" id="" cols="30" rows="2"
                        class="px-2.5 pl-[20px] py-[8px] w-[100%] border border-solid border-[#d8d8d8] rounded-[6px] focus-within:border-[#0071AF] focus-within:border focus-within:border-solid outline-0 text-[13px] resize-none"></textarea>
                </div>
                <div class="relative flex justify-between mt-5 w-full">
...
Người sửa: Phạm Huyền My
                ...
                <div class="justify-end flex mt-5">
                    <button
                        ...
                        bỏ</button>
                    <button class="text-[12px] bg-[#15A5E3] text-white rounded-[6px] px-[14px] py-[7px]">Thêm
                        mới</button>
                </div>
            </div>
        </div>
